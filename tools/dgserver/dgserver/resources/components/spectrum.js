...
(function (window, $, undefined) {
    var defaultOpts = {
        ...
        color: false,
        flat: false,
        showInput: true,           //输入颜色框
        allowEmpty: false,          //预览颜色框
        showButtons: true,          //choose、cancel按钮
        clickoutFiresChange: false,
        showInitial: false,
        showPalette: true,         //显示调色板
        showPaletteOnly: false,     //只显示调色板
        ...
        containerClassName: "",
        replacerClassName: "",
        showAlpha: true,           //显示调节透明度
        theme: "sp-light",
        palette: [
            ["rgb(0, 165, 165)", "rgb(52, 168, 185)", "rgb(0, 0, 0)", "rgb(67, 67, 67)", "rgb(102, 102, 102)", "rgb(204, 204, 204)", "rgb(217, 217, 217)", "rgb(255, 255, 255)"],
    ...
    function spectrum(element, o) {
        ...
        var doc = element.ownerDocument,
            ...
            previewValElement = replacer.find(".sp-color-inner"),
        ...
        function updateUI() {
            ...
            previewValElement.html(opts.color);
            //textInput.val(opts.color);
        ...
        function updateOriginalInput(fireCallback) {
            ...
            previewValElement.html(color.toString('hex8'));
            textInput.val(color.toString('hex8'));
            opts.callback(color.toString('hex8'));
        }

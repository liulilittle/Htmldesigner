...
var HtmlView = function () {
    ...
    this.Audio = function () {
        ...
        var audio = $(_audioElement).find("audio");
        var src = arguments[0];
        if (_audio !== src) {
            _audio = src;

            audio.attr('src', _audio);
        }
    }
    // 获取或设置控件背景声音是否为静音
    ...
    !(function () {
        ...
        _audioElement = $('<div class="HtmlView_Audio"><audio autoplay loop></audio></div>')
        _container.append(_imageElement);
        _container.append(_audioElement);
...
HtmlView.prototype.GetType = function () {
    ...
    type.Properties = [{
        ...
        Name: 'Audio',
        PropertyType: 'Url,Audio,string',
        Readable: true,
        Writeable: true,
        Browsable: true,
        DataBind: false,
        Description: '获取或设置背景声音。',
        Accessor: 'function',
    }, {
        Name: 'ISMutedAudio',
        PropertyType: 'boolean',
